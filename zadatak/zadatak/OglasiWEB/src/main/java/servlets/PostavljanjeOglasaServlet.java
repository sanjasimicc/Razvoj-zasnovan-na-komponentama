...
/**
 * Servlet implementation class PostavljanjeOglasaServlet
 */
@WebServlet("/PostavljanjeOglasaServlet")
public class PostavljanjeOglasaServlet extends HttpServlet {
     ...
     */
    public PostavljanjeOglasaServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Ogla o = bean.saveOglas(tekst, brojPregleda , idKorisnik);
		
		if(o != null) {
			request.setAttribute("bean2", bean);
			request.setAttribute("o", o);
			request.getRequestDispatcher("/PostavljanjeOglasa.jsp").forward(request, response);
		} else {
